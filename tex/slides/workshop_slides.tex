...
{\Large $\star$}
\begin{itemize}
    \item \textbf{Autonomous} task completion
    \item \textbf{Multi-step} reasoning
    \item \textbf{Context-aware} assistance
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\centering
\textbf{Key Tools for Agentic AI:} \\[0.2cm]
GitHub Copilot (local \& cloud) $\bullet$ VS Code Chat modes \\
Cline + Continue (offline capable!) $\bullet$ Cursor $\bullet$ Windsurf
}}
\end{center}
\end{frame}
