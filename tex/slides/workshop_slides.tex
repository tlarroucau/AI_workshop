...
\vspace{0.3cm}
Repository available at: \url{https://github.com/yourusername/AI_workshop}
\end{frame}
...
\begin{enumerate}
    \item \textbf{Command Palette} (Ctrl/Cmd+Shift+P)
    \begin{itemize}
        \item Access all commands and features
        \item Quick navigation and actions
    \end{itemize}
    
    \item \textbf{Integrated Terminal}
    \begin{itemize}
        \item Run commands without leaving editor
        \item Multiple terminals, split views
    \end{itemize}
    
    \item \textbf{Extensions}
    \begin{itemize}
        \item Python, LaTeX, Markdown support
        \item Git integration enhanced
        \item AI coding assistants
    \end{itemize}
    
    \item \textbf{Source Control Panel}
    \begin{itemize}
        \item Visual Git interface
        \item Stage, commit, push with clicks
    \end{itemize}
\end{enumerate}
\end{frame}

\begin{frame}{Key Extensions for Research}
\begin{table}
\small
\begin{tabular}{ll}
\toprule
...
LaTeX Workshop & Compile and preview LaTeX documents \\
GitHub Copilot & AI code completion and chat \\
GitLens & Enhanced Git visualization \\
Markdown All in One & Preview and edit markdown files \\
\bottomrule
\end{tabular}
\end{table}

\vspace{0.3cm}
\textbf{Demo:} Installing and configuring extensions
\end{frame}
...
\begin{itemize}
    ...
    \item Use branch protection rules
\end{itemize}
\end{block}

\begin{block}{Communication}
\begin{itemize}
    \item Issues for all tasks and discussions
    \item PR comments for code-specific feedback
...
\begin{itemize}
    ...
    \item Tables: LaTeX format in \texttt{output/tables/}
    \item Gitignore outputs, rebuild via Makefile
\end{itemize}
\end{block}
\end{frame}
...
\begin{itemize}
    ...
    \item Cursor, Cline, Windsurf (alternatives)
\end{itemize}
\end{frame}
...
\begin{enumerate}
    ...
    \item Ask for help with specific tasks
...
\textbf{GitHub Copilot Workspace (Cloud):}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Collaborate across timezones
\end{itemize}

\vspace{0.3cm}
\textbf{Demo:} Creating issue and using Copilot Workspace
\end{frame}
...
\midrule
\textbf{ChatGPT/Claude} & General research assistance \\
...
\textbf{Scenario:} Add a new robustness check

\begin{enumerate}
    \item Create GitHub issue: "Add robustness check with clustered SE"
    \item Create branch: \texttt{feature/clustered-se}
    \item Use Copilot to generate code
    \item Update analysis script
    \item Run Makefile to regenerate outputs
    \item Commit changes
    \item Push and create PR
    \item Review and merge
\end{enumerate}

\vspace{0.3cm}
\textbf{We'll work through this together!}
\end{frame}
...
\midrule
Merge conflicts & Communicate with team, pull often \\
...
\textbf{This Month:}
\begin{itemize}
    \item Fully adopt Git/GitHub for active projects
    \item Integrate AI tools into daily workflow
    \item Teach workflow to lab mates
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item Copilot: \url{github.com/features/copilot}
\end{itemize}
\end{block}
...
\begin{itemize}
    ...
    \item Missing Semester: \url{missing.csail.mit.edu}
\end{itemize}
\end{block}

\begin{block}{Workshop Materials}
\begin{itemize}
    \item Template repo: \url{github.com/yourusername/AI_workshop}
    \item These slides: In \texttt{tex/slides/}
\end{itemize}
\end{block}
\end{frame}
...
\normalsize
\textbf{Contact:} yourname@asu.edu

\vspace{0.5cm}

\textbf{Template Repository:} \\
\url{github.com/yourusername/AI_workshop}
